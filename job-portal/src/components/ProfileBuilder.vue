      ...
      <div class="container main-container">
        <b-card style="max-height: 85vh; overflow-y: auto; min-height: 40vh">
          ...
          >
            ...
            <tab-content
              :title="role === 'student' ? 'Personal Details' : 'Organizational Details'"
              icon="ti-user"
              ...
              <b-form>
                ...
                <b-form-group>
                  <b-form-select
                    v-if="role === 'student'"
                    v-model="user.gender"
                    :options="['Male', 'Female', 'I don\'t wish to state']"
                  ></b-form-select>
                </b-form-group>
                ...
                <b-form-group id="fieldsetHorizontal6" v-if="role === 'student'">
    ...
    validateAsync: function() {
      return new Promise((resolve, reject) => {
        ...
        if (this.activeIndex === 0) {
          ...
          axios
            .post(`http://localhost:3000/api/profile/personal`, obj, {
              headers: params
            })
            .then(response => {
              resolve(true);
          ...
          if (this.role === "student") {
            ...
            for (let i = 0; i < this.educations.length; i++) {
              ...
              vals.add(this.educations[i].description === "");
              if (
          ...
          if (this.skills.length > 0) {
            ...
            // var skillsArray = []
            // thinpm ss.skills.forEach(skill => {
            ...
            axios
              .post(`http://localhost:3000/api/profile/skills`, obj, {
                headers: params
              })
              .then(response => {
                resolve(true);
        ...
        inputValidator: value => {
          return new Promise((resolve, reject) => {
            if (value === "student" || value === "employer") {
              ...
              axios
                .post("http://localhost:3000/api/profile/updateRole", obj, {
                  headers: params
                })
                .then(resposne => {
